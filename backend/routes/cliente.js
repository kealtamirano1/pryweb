...
api.get(
  '/obtener_direccion_cliente/:id',
  auth.auth,
  clienteController.obtener_direccion_cliente
);
api.put(
  '/cambiar_direccion_principal/:id/:cliente',
  auth.auth,
  clienteController.cambiar_direccion_principal
);
api.get(
